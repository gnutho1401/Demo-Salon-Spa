    ...
    await pool.query(`
      ...
      BEGIN
          CREATE TABLE AISkinAnalysisHistory (
              ...
              SkinType NVARCHAR(MAX) NOT NULL,
              AcneLevel NVARCHAR(MAX) NOT NULL,
              WrinkleLevel NVARCHAR(MAX) NOT NULL,
              DarkSpots NVARCHAR(MAX) NOT NULL,
              Redness NVARCHAR(MAX) NOT NULL,
