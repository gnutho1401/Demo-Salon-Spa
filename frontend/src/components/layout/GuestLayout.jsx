...
export default function GuestLayout({ children }) {
  ...
  return <>
    <div className={headerClass}>
      <div className="topbar">
        ...
        <div className="topbar-info">
          ...
          <span>📍 Chi nhánh: <strong>Hải Châu, Đà Nẵng</strong></span>
          <span>🕒 Mở cửa: <strong>08:00 - 20:00</strong></span>
        </div>
      </div>
    ...
    {!['/login', '/register', '/verify-email', '/forgot-password', '/reset-password'].includes(location.pathname) && (
