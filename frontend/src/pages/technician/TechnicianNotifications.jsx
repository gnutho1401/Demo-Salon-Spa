      ...
      >
        ...
        >
          <div>
            ...
            >
              Xem các cập nhật về lịch hẹn mới, đánh giá và chia sẻ hoa hồng
              doanh thu
            </p>
          </div>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <span
              style={{ fontSize: "13px", fontWeight: 700, color: "#4e5a52" }}
            >
              Lọc loại:
            </span>
            <select
              ...
              {filteredNotifications.map((n) => {
                ...
                return (
                  <div
                    ...
                    onClick={() =>
                      !n.IsRead && handleMarkRead(n.NotificationId)
                    }
                    style={{
                      display: "flex",
                      gap: "16px",
                      ...
                      backgroundColor: n.IsRead
                        ...
                        : "rgba(45, 106, 79, 0.03)",
                      border: n.IsRead
                        ? "1px solid rgba(226, 220, 208, 0.4)"
