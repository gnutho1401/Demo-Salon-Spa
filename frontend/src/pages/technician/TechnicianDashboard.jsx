  ...
  const weeklyScheduleMapped = useMemo(() => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      const matched = (dashboard?.weeklySchedule || []).find((s) => {
        ...
        const sDate = s.ShiftDate.toISOString
          ? s.ShiftDate.toISOString().slice(0, 10)
          : String(s.ShiftDate).slice(0, 10);
      ...
      days.push({
        ...
        dayNum: d.getDate(),
        fullDateLabel: d.toLocaleDateString("vi-VN", {
          day: "numeric",
          month: "numeric",
        }),
      ...
      >
        ...
        >
          <div>
            ...
            >
              Chào buổi sáng,{" "}
              {dashboard?.technician?.FullName || "Kỹ thuật viên"}! 🌿
            </h1>
            <p
              style={{
                margin: "4px 0 0",
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                {stats.todayAppointments} lịch hẹn
              </div>
              <span
                ...
                >
                  <span
                    style={{
                      fontSize: "0.75rem",
                      fontWeight: "bold",
                      color: day.isToday ? "#2f593a" : "#4a5568",
                    }}
                  >
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        fontWeight: "bold",
                        backgroundColor:
                          day.shiftName === "Nghỉ" ? "#f7fafc" : "#e6f4ea",
        ...
        >
          ...
          >
            ...
            <svg width="240" height="200" style={{ margin: "10px 0" }}>
              {/* Outer lines */}
              <polygon
                points="120,20 200,75 170,165 70,165 40,75"
                fill="none"
                stroke="#edf2f7"
                strokeWidth="1"
              />
              <polygon
                points="120,50 180,90 155,150 85,150 60,90"
                fill="none"
                stroke="#edf2f7"
                strokeWidth="1"
              />
              <polygon
                points="120,80 150,105 140,135 100,135 90,105"
                fill="none"
                stroke="#edf2f7"
                strokeWidth="1"
              />
              ...
              <polygon
                points="120,23 194,76 164,160 77,159 45,76"
                fill="rgba(216, 181, 109, 0.25)"
                stroke="#d8b56d"
                strokeWidth="2.5"
              />
        ...
        >
          ...
          >
            ...
            >
              {[
                {
                  title: "Khách hàng Trần Thị Mai đã đến",
                  time: "09:25 AM",
                  icon: "👤",
                  color: "#3182ce",
                },
                {
                  title: "Lịch hẹn 15:00 PM đã được xác nhận",
                  time: "08:30 AM",
                  icon: "✓",
                  color: "#38a169",
                },
                {
                  title: "Đánh giá mới 5⭐ từ Lê Thị Hương",
                  time: "08:15 AM",
                  icon: "⭐",
                  color: "#ecc94b",
                },
