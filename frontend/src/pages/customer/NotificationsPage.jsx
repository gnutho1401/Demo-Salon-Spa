  ...
  return (
    <CustomerLayout>
      <div className="notifications-page-container">
        ...
        {/* Section Head */}
        <div className="section-head" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
          <div>
            <div className="eyebrow">Notifications</div>
            <h2 className="section-title" style={{ margin: '4px 0 0 0' }}>Thông báo của tôi</h2>
          </div>
          {items.length > 0 && (
            <button 
              type="button" 
        ...
        {message && <p className="muted" style={{ color: '#e8396c', fontWeight: 600 }}>{message}</p>}
        ...
        <div className="notification-list" style={{ display: 'grid', gap: 16 }}>
          {items.length > 0 ? (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 16, flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                    <h3 style={{ margin: 0, fontSize: '15px', fontWeight: n.IsRead ? '600' : '800', color: '#2d2430' }}>
                      {n.Title}
                    </h3>
                    <p style={{ margin: 0, fontSize: '13.5px', color: '#675464', lineHeight: 1.4 }}>
                      {n.Content}
                    </p>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 4 }}>
                      <span style={{ fontSize: '11px', color: '#a38f9d', fontWeight: 500 }}>
                ...
                <div style={{ marginLeft: 16 }}>
                  {!n.IsRead ? (
                    <button 
                      ...
                      onMouseOver={(e) => { e.currentTarget.style.background = '#ff4778'; e.currentTarget.style.color = '#ffffff'; }}
                      onMouseOut={(e) => { e.currentTarget.style.background = '#ffeef2'; e.currentTarget.style.color = '#ff4778'; }}
                    >
                      ✓ Đã đọc
                    </button>
                  ) : (
                    <span style={{ color: '#b9a8b4', fontSize: '12px', fontWeight: 500 }}>
                      Đã xem
                    </span>
                  )}
                </div>
            ...
            >
              ...
              <h3 style={{ margin: '0 0 8px 0', fontSize: '16px', color: '#ff4778', fontWeight: 700 }}>Không có thông báo nào</h3>
              <p className="muted" style={{ margin: 0, fontSize: '13px', color: '#a38f9d' }}>Bạn hiện tại không có thông báo mới nào từ salon.</p>
            </div>
          )}
        </div>
      </div>
