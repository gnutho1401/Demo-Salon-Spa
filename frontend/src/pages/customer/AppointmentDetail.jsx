                    ...
                    <article className="ap-v2-service-card" key={s.AppointmentServiceId || s.ServiceId}>
                      ...
                      <div className="ap-v2-service-info">
                        ...
                        <div className="ap-v2-service-meta">
                          ...
                          {s.TechnicianName && (
                            <div style={{ marginTop: 6, display: "flex", alignItems: "center", gap: 6, fontSize: 12, color: "#1d4ed8", background: "#eff6ff", padding: "4px 10px", borderRadius: 8, border: "1px solid #bfdbfe" }}>
                              <img
                                src={resolveFileUrl(s.TechnicianAvatar) || "/images/avatars/default-avatar.png"}
                                alt={s.TechnicianName}
                                style={{ width: 22, height: 22, borderRadius: "50%", objectFit: "cover", border: "1px solid #2563eb" }}
                              />
                              <span>KTV phụ trách: <b>{s.TechnicianName}</b></span>
                            </div>
                          )}
