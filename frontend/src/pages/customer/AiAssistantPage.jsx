              ...
              <div className="ai-widget-stylist-item" key={emp.EmployeeId}>
                <div className="ai-widget-stylist-profile">
                  ...
                  <div className="ai-widget-stylist-details">
                    <h4>{emp.FullName}</h4>
                    <span>
                      {emp.Specialization || emp.Position || "Kỹ thuật viên"}
                    </span>
                    <small>
                          ...
                          {rescheduleSelectedSlot && (
                            ...
                            >
                              {rescheduleActionLoading
                                ? "Đang cập nhật..."
                                : `Xác nhận đổi sang ${rescheduleSelectedSlot}`}
                            </button>
                          )}
                        </div>
                      </>
                  ...
                  {vouchers.length > 0 && (
                    ...
                    >
                      ...
                      >
                        ...
                        {vouchers.map((v) => {
                          const originalPrice = serviceDetail
          ...
          >
            <div>
              ...
              <h2 className="section-title" style={{ margin: "4px 0 0 0" }}>
                Trợ lý AI Beauty Salon
              </h2>
              <p className="subtitle" style={{ margin: "4px 0 0 0" }}>
                Hỏi bất kỳ điều gì về dịch vụ, giá cả, đặt lịch — AI sẽ tư vấn
                cho bạn!
              </p>
            </div>
              ...
              <div className="ai-chat-messages" onClick={handleChatClick}>
                {messages.length === 0 && !loading && (
                  <div className="ai-welcome">
                    ...
                    <h3>Xin chào! 👋</h3>
                    <p>
                      Mình là trợ lý AI của Beauty Salon. Hãy gửi câu hỏi đầu
                      tiên để bắt đầu cuộc trò chuyện mới nhé!
                    </p>
                  </div>
                )}
                ...
                {messages.map((m, idx) => {
                  ...
                  if (widget)
                    cleanAnswer = cleanAnswer.replace(widget.rawTag, "").trim();
                  ...
                  return (
                    <div key={m.ChatId || `${m.Question}-${m.CreatedAt}`}>
                      ...
                      {isLast && !loading && suggestions.length > 0 && (
                        <div
                          className="ai-quick-suggestions"
                ...
                <div className="ai-rec-grid">
                  {recommendations.map((r, i) => (
                    <div
                      ...
                      key={r.RecommendationId || r.ServiceId || i}
                    >
                      <strong>{r.ServiceName}</strong>
                      <span>{r.Reason || r.Description}</span>
                      {r.Price && (
                        <span style={{ color: "#ff4778", fontWeight: 700 }}>
                      ...
                      {r.ServiceId && (
                        <Link
                          ...
                          to={`/customer/booking?serviceId=${r.ServiceId}`}
                        >
                          Đặt lịch
                        </Link>
                      )}
