  ...
  return (
    <>
      <section className="hero">
        <div className="container hero-inner">
          <div className="hero-content animated-panel">
            ...
            <p>
              Beauty Salon & Spa hỗ trợ khách hàng xem dịch vụ, chọn kỹ thuật
              viên, đặt lịch, thanh toán và theo dõi lịch hẹn nhanh chóng.
            </p>
            ...
            <div className="hero-actions">
              ...
              <Link to="/technicians" className="btn btn-outline">
                Xem kỹ thuật viên
              </Link>
            </div>
      ...
      <div className="container search-box enhanced-search">
        ...
        <button className="btn" type="button" onClick={handleQuickBooking}>
          Tìm & đặt lịch
        </button>
      </div>
              ...
              <div className="service-body">
                ...
                <div className="card-action-row">
                  <Link to={`/services/${s.ServiceId}`}>
                    <button className="card-btn">Chi tiết</button>
                  </Link>
                  <Link to={`/customer/booking?serviceId=${s.ServiceId}`}>
                    <button className="card-btn primary">Đặt lịch</button>
                  </Link>
                </div>
              </div>
            </div>
      ...
      <section id="technicians" className="section container">
        <div className="section-head">
          ...
          <Link className="see-all" to="/technicians">
            Xem tất cả →
          </Link>
        </div>
