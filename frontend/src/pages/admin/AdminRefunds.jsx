...
export default function AdminRefunds() {
  ...
  async function handleReject(e) {
    ...
    try {
      setError("");
      setSuccessMsg("");
      await axiosClient.post(`/admin/refunds/${selectedRefundId}/reject`, {
        reason: rejectReason,
      });
    ...
    <div className="refund-hub-container">
      ...
      <div className="refund-header-wrapper">
        <div className="refund-header-title">
          ...
          <p>
            Xử lý, đối soát và hoàn tiền tự động hoặc thủ công cho khách hàng
          </p>
        </div>
      ...
      <div className="refund-stats-grid">
        ...
        >
          <div className="refund-stat-info">
            ...
            <span className="refund-stat-subtext">
              Cần hoàn: {money(stats.pending.sum)}
            </span>
          </div>
        ...
        >
          <div className="refund-stat-info">
            ...
            <span className="refund-stat-subtext">
              Tổng tiền: {money(stats.completed.sum)}
            </span>
          </div>
          <div className="refund-stat-icon-wrapper">
            <svg
        ...
        >
          <div className="refund-stat-info">
            ...
            <span className="refund-stat-subtext">
              Tổng tiền: {money(stats.rejected.sum)}
            </span>
          </div>
          <div className="refund-stat-icon-wrapper">
            <svg
      ...
      {successMsg && (
        <div className="admin-alert success" style={{ margin: 0 }}>
          {successMsg}
        </div>
      )}
          ...
          filteredRefunds.map((r) => (
            <div className="refund-item-card" key={r.RefundId}>
              ...
              <div className="refund-col-id">
                <span className="refund-code-badge">
                  #{String(r.RefundId).padStart(4, "0")}
                </span>
                <span className="refund-meta-sub">
                  Mã Refund: #{r.RefundId}
                </span>
                <span className="refund-meta-sub">
                  Mã Payment: #{r.PaymentId}
                </span>
              ...
              <div className="refund-col-billing">
                <span
                  className={`refund-method-badge ${String(r.PaymentMethod || "").toLowerCase()}`}
                >
                  {r.PaymentMethod}
                </span>
                {r.TransactionCode && (
                  <span
                    className="refund-tx-code"
                  ...
                  <div className="refund-bank-card-mock">
                    ...
                    <div className="refund-bank-number">
                      ...
                      <button
                        ...
                        onClick={() =>
                          handleCopy(r.AccountNumber, "số tài khoản")
                        }
                    ...
                    <div className="refund-bank-holder">{r.AccountName}</div>
                  </div>
                ) : (
                  <span
                    style={{
              ...
              <div className="refund-col-amount">
                ...
                >
                  <span className="refund-amount-val">
                    {money(r.RefundAmount)}
                  </span>
                  <span
                    className={`refund-status-custom-badge ${String(r.RefundStatus).toLowerCase()}`}
                  >
                ...
                {r.RefundReason && (
                  <span
                    className="refund-meta-sub"
                    style={{ fontStyle: "italic", whiteSpace: "normal" }}
                  >
                ...
                >
                  ...
                  {r.RefundStatus === "REJECTED" && (
                    <div
                      className="refund-processed-info"
                      style={{ color: "#b91c1c", backgroundColor: "#fff2f2" }}
                    >
      ...
      <AdminConfirmDialog
        ...
        details={
          confirmRefund ? (
            <>
              <strong>
                {confirmRefund.refund.CustomerName || "Khách hàng"}
              </strong>
        ...
        confirmLabel={
          confirmRefund?.manual ? "Đã chuyển tiền" : "Hoàn qua PayOS"
        }
        tone="danger"
