                        ...
                        <div style={{ marginTop: 8, borderTop: "1px dashed #cbd5e1", paddingTop: 14 }}>
                          ...
                          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 12 }}>
                            {servicesList.map((svcStep, idx) => {
                              ...
                              const isUnlocked = isCheckInDone && prevStepsCompleted;
                                ...
                                >
                                  <div>
                                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 6 }}>
                                      ...
                                      <span style={{
                                        ...
                                        padding: "2px 6px",
                                        borderRadius: 6,
                                        background: isCompleted ? "#dcfce7" : isInProgress ? "#e0f2fe" : isUnlocked ? "#fef3c7" : "#e2e8f0",
                                        color: isCompleted ? "#15803d" : isInProgress ? "#0369a1" : isUnlocked ? "#b45309" : "#64748b"
                                      }}>
                                        {isCompleted ? "✓ ĐÃ XONG" : isInProgress ? "▶️ ĐANG LÀM" : isUnlocked ? "⏳ CHỜ LÀM" : "🔒 KHÓA"}
                                      </span>
                                    </div>
                                  ...
                                  <div style={{ marginTop: 10 }}>
                                    {isCompleted ? (
                                      ...
                                      >
                                        {!isCheckInDone ? "🔒 Cần Check-in trước" : !prevStepsCompleted ? `🔒 Chờ xong bước ${idx}` : "✓ Xác Nhận Xong Bước Này"}
                                      </button>
                                    )}
                                  </div>
