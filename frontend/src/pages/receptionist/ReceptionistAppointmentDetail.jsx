...
export default function ReceptionistAppointmentDetail() {
  ...
  const canCheckout =
    ["IN_PROGRESS", "COMPLETED"].includes(status) && !item?.CheckedOutAt;
  ...
  const canReschedule =
    ![
      ...
      "REFUND_PENDING",
      "NO_SHOW",
    ].includes(status) && !item?.CheckedInAt;
  ...
  const selectedRescheduleEmp = useMemo(() => {
    return employees.find(
      (emp) => String(emp.EmployeeId) === String(rescheduleForm.technicianId),
    );
  ...
  async function handleCheckout() {
    if (
      !window.confirm("Xác nhận khách hàng đã làm xong và check-out rời salon?")
    )
      return;
  ...
  async function handleCreateInvoice() {
    try {
      ...
      const res = await axiosClient.post(
        `/receptionist/appointments/${id}/create-invoice`,
      );
    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Không tải được danh sách kỹ thuật viên rảnh",
      );
    } finally {
    ...
    async function checkWorkload() {
      ...
      try {
        ...
        const res = await axiosClient.get(
          `/receptionist/technicians/${selectedTechId}/workload`,
          {
            params: { date: dateStr },
          },
        );
  ...
  async function submitAssignTech(e, overrideOverload = false) {
    ...
    try {
      ...
      await axiosClient.put(
        `/receptionist/appointments/${id}/assign-technician`,
        {
      ...
      if (errMsg.includes("OVERLOAD_WARNING")) {
        if (
          window.confirm(
            "Kỹ thuật viên này đã có nhiều ca làm việc hôm nay (Quá tải). Bạn có chắc chắn muốn tiếp tục phân công không?",
          )
        ) {
    ...
    try {
      ...
      setSuccess(
        res.data?.message ||
          ...
          "Đã gửi đề xuất đổi lịch hẹn tới khách hàng để xác nhận!",
      );
      window.scrollTo({ top: 0, behavior: "smooth" });
    } catch (err) {
        ...
        <div className="ra-detail-header" style={{ marginBottom: "22px" }}>
          <div>
            ...
            <p style={{ color: "#6f766f", margin: "4px 0 0" }}>
              Quản lý ca trực phục vụ, thay đổi lịch biểu, xác nhận thanh toán
              trực quầy và check-in cho khách.
            </p>
          </div>

          {item ? (
            <div
              className="ra-header-badges"
        ...
        {item ? (
          <>
              ...
              <div className="ra-hero-card">
                ...
                <div>
                  ...
                  <p>
                    ...
                    {item.CustomerEmail || "Không có Email"}
                  </p>
                </div>
              </div>
            ...
            <div className="ra-grid">
              ...
              >
                <section
                  className="ra-card ra-main-card"
                  style={{ width: "100%" }}
                >
                  ...
                  <div className="ra-info-grid">
                    ...
                    <div>
                      ...
                      <strong>
                        {item.TechnicianName || "Chưa chỉ định KTV"}
                      </strong>
                    ...
                    >
                      ...
                      <strong style={{ color: "#85583f" }}>
                        {item.BranchName || "Chi nhánh chính"}
                      </strong>
                      {item.BranchAddress && (
                        <p
                          style={{
                    ...
                    {item.CancelReason && (
                      ...
                      >
                        <label style={{ color: "#d32232" }}>
                          Lý do hủy lịch hẹn
                        </label>
                        <strong style={{ color: "#d32232" }}>
                          {item.CancelReason}
                        </strong>
                      </div>
                    )}
                ...
                <section className="ra-card">
                  ...
                  <div className="ra-profile-line">
                    ...
                    <div>
                      ...
                      <p style={{ color: "#7d837d", margin: "4px 0 0" }}>
                        📞 {item.CustomerPhone || "Không có SĐT"}
                      </p>
                      <p style={{ color: "#7d837d", margin: "2px 0 0" }}>
                        ✉ {item.CustomerEmail || "Không có Email"}
                      </p>
                    </div>
                  </div>
                ...
                <section className="ra-card">
                  ...
                  <div className="ra-profile-line">
                    ...
                    <div>
                      ...
                      <p style={{ color: "#7d837d", margin: "4px 0 0" }}>
                        📞 {item.TechnicianPhone || "Chưa cập nhật SĐT"}
                      </p>
                      <p style={{ color: "#7d837d", margin: "2px 0 0" }}>
                        💼{" "}
                        {item.Specialization ||
                ...
                <section className="ra-card">
                  ...
                  <div className="ra-money-list">
                    ...
                    >
                      ...
                      <b style={{ color: "#d91f68", fontSize: "16px" }}>
                  ...
                  >
                    ...
                    <div className="ra-money-list">
                      <div>
                        ...
                        <span
                          className={statusClass(item.RefundInfo.RefundStatus)}
                      ...
                      <div>
                        ...
                        <b>
                          {item.RefundInfo.RefundReason || "Không ghi lý do"}
                        </b>
                      </div>
                      {item.RefundInfo.MomoMessage && (
                        <div>
                          <span>Ghi chú MOMO/PayOS</span>
                          <small style={{ color: "#7d837d", marginTop: "3px" }}>
                            {item.RefundInfo.MomoMessage}
                          </small>
                        </div>
                      )}
            ...
            <section
              className="ra-card ra-action-card"
              style={{ marginTop: "24px" }}
            >
              <div className="ra-card-title">
                <h3>Khu vực xử lý nghiệp vụ Lễ tân</h3>
                <span style={{ fontSize: "12px", color: "#6f766f" }}>
                  Các hành động tương ứng với trạng thái hiện tại của ca hẹn
                </span>
              </div>
            ...
            {showPayment && (
              <div className="ra-modal-backdrop">
                <form className="ra-modal" onSubmit={markPaid}>
                  ...
                  <p>
                    Hệ thống sẽ cập nhật trạng thái hóa đơn là đã quyết toán
                    thành công.
                  </p>
            ...
            {showCancel && (
              ...
              >
                <form
                  ...
                  style={{ maxWidth: "550px", width: "95%", margin: "auto" }}
                >
                  <h3
                    style={{
                      fontSize: "1.25rem",
                  ...
                  >
                    Xác nhận hủy lịch hẹn cho khách hàng. Vui lòng kiểm tra loại
                    dịch vụ để xử lý hoàn tiền/buổi học chính xác.
                  </p>
                  ...
                  {itemPaymentMethod === "PACKAGE" ? (
                    ...
                    >
                      📦 DỊCH VỤ TRONG COMBO/LIỆU TRÌNH:
                      <br />
                      Lịch này sử dụng gói combo. Sau khi hủy, hệ thống sẽ tự
                      động hoàn trả lại 1 buổi sử dụng vào tài khoản Gói Combo
                      của khách hàng.
                    </div>
                  ) : paymentStatus === "PAID" ? (
                    <div
                    ...
                    >
                      💳 DỊCH VỤ LẺ ĐÃ THANH TOÁN:
                      <br />
                      Lịch này là dịch vụ lẻ đã thanh toán bằng tiền mặt/chuyển
                      khoản. Sau khi hủy, hệ thống sẽ tạo yêu cầu hoàn tiền. Vui
                      lòng điền thông tin tài khoản ngân hàng của khách hàng ở
                      dưới.
                    </div>
                  ) : (
                    <div
                    ...
                    >
                      ✏️ DỊCH VỤ LẺ CHƯA THANH TOÁN:
                      <br />
                      Lịch hẹn này chưa thanh toán. Trạng thái lịch sẽ chuyển
                      sang Đã hủy và không phát sinh yêu cầu hoàn tiền.
                    </div>
                  )}
            ...
            {showReschedule && (
              ...
              >
                <form
                  className="ra-modal wide"
                  onSubmit={submitReschedule}
                  style={{ maxWidth: "800px", width: "95%", margin: "auto" }}
                >
                  <style>{`
                    .rx-reschedule-step {
                      margin-bottom: 24px;
                  ...
                  >
                    Cập nhật thời gian hẹn mới và phân công kỹ thuật viên cho
                    lịch hẹn này.
                  </p>
                  ...
                  <div className="rx-reschedule-step">
                    <div className="rx-reschedule-step-title">
                      ...
                      <div className="rx-reschedule-step-text">
                        Chọn kỹ thuật viên ({employees.length} người phù hợp)
                      </div>
                    </div>
                    {employees.length === 0 ? (
                      <div
                        ...
                        {employees.map((emp) => (
                          <button
                            ...
                            className={`rx-reschedule-employee-card ${
                              String(rescheduleForm.technicianId) ===
                          ...
                          >
                            <img
                              src={
                                resolveFileUrl(emp.ImageUrl) || DEFAULT_AVATAR
                              }
                    ...
                    {selectedRescheduleEmp && (
                      ...
                      >
                        ...
                        >
                          Chi nhánh hoạt động của chuyên viên:{" "}
                          {selectedRescheduleEmp.BranchName ||
                            "Chi nhánh chính"}
                        </span>
                  ...
                  <div className="rx-reschedule-step">
                    ...
                    !rescheduleForm.technicianId ? (
                      <div className="rx-reschedule-slot-empty">
                        Vui lòng chọn ngày hẹn và kỹ thuật viên trước để xem các
                        khung giờ trống.
                      </div>
                    ) : slotLoading ? (
                      <div className="rx-reschedule-slot-empty">
                      ...
                      <div className="rx-reschedule-slot-empty">
                        Không tìm thấy khung giờ nào trống cho kỹ thuật viên này
                        vào ngày đã chọn.
                      </div>
                    ) : (
                      <div className="rx-reschedule-slot-grid">
                        {slots.map((slot) => {
                          ...
                          const isActive =
                            formatTime(rescheduleForm.startTime) ===
                            formattedStart;
                          return (
                            <button
                              key={slot.startTime}
            ...
            {showAssignTech && (
              ...
              >
                <form
                  className="ra-modal"
                  onSubmit={(e) => submitAssignTech(e, false)}
                  style={{ maxWidth: "550px", width: "95%", margin: "auto" }}
                >
                  <h3
                    style={{
                  ...
                  >
                    Chọn kỹ thuật viên rảnh phù hợp cho dịch vụ này. Hệ thống sẽ
                    tự động phát hiện tình trạng lịch nghỉ phép hoặc quá tải.
                  </p>
                      ...
                      {techWorkload && (
                        ...
                        >
                          ...
                          <ul style={{ margin: "5px 0 0 15px", padding: 0 }}>
                            <li>
                              Tổng số ca hẹn đã gán:{" "}
                              <strong>
                                {techWorkload.totalAppointments} ca
                              </strong>
                            </li>
                            {techWorkload.isOverloaded && (
                              <li
                              ...
                              >
                                ⚠️ Cảnh báo: Kỹ thuật viên quá tải ca (&gt;= 5
                                ca/ngày)
                              </li>
                            )}
                            {techWorkload.isConsecutiveOverloaded && (
                              <li
                                style={{ color: "#ef4444", fontWeight: "bold" }}
                              >
                                ⚠️ Cảnh báo: Có &gt;= 3 ca làm việc liên tiếp
                                không nghỉ
                              </li>
                            )}
                            {!techWorkload.isOverloaded &&
                              !techWorkload.isConsecutiveOverloaded && (
                                <li>
                                  Tải trọng công việc: Bình thường (Hợp lý)
                                </li>
                              )}
                          </ul>
                        </div>
