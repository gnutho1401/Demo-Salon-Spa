        ...
        >
          <div>
            ...
            <p style={{ color: "#718096", margin: "4px 0 0 0" }}>
              Quản lý các thông báo về hoạt động của salon, yêu cầu khách hàng
              và hệ thống.
            </p>
          </div>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    background:
                      filterType === "ALL" ? "#f7fafc" : "transparent",
                ...
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    background:
                      filterType === "UNREAD" ? "#f7fafc" : "transparent",
                ...
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    background:
                      filterType === "READ" ? "#f7fafc" : "transparent",
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      background:
                        categoryType === cat.key ? "#f7fafc" : "transparent",
